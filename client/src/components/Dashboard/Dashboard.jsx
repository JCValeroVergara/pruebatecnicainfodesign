...
const Dashboard = () => {
  ...
  return (
    <main className="w-full flex flex-col justify-center items-center py-10">
      <Title
        className="self-center text-center uppercase text-5xl font-bold whitespace-nowrap dark:text-white"
        style={{ width: '100%' }}
      >
        Analisis de Datos
      </Title>
      ...
      <TabGroup className="mt-6 w-full">
        <TabList className="flex flex-wrap text-2xl font-bold text-center text-white border-b border-gray-200 dark:border-gray-700 dark:text-white w-full items-center justify-center">
          <Tab className="inline-block p-4 rounded-t-lg text-gray-800 dark:text-white hover:text-gray-700 hover:bg-yellow-500 dark:hover:bg-yellow-500 dark:hover:text-gray-700">Consumos</Tab>
          <Tab className="inline-block p-4 rounded-t-lg text-gray-800 dark:text-white hover:text-gray-700 hover:bg-yellow-500 dark:hover:bg-yellow-500 dark:hover:text-gray-700">Tabla Tramo/Día</Tab>
          <Tab className="inline-block p-4 rounded-t-lg text-gray-800 dark:text-white hover:text-gray-700 hover:bg-yellow-500 dark:hover:bg-yellow-500 dark:hover:text-gray-700">Tabla Cliente/Día</Tab>
          <Tab className="inline-block p-4 rounded-t-lg text-gray-800 dark:text-white hover:text-gray-700 hover:bg-yellow-500 dark:hover:bg-yellow-500 dark:hover:text-gray-700">Pedidas por Cliente</Tab>
        </TabList>
